...
function ControlChromecastSpeakerPlatform(log, config, api) {
...
ControlChromecastSpeakerPlatform.prototype.scanAccesories = function () {

  let addChromecast = function(device){
    if(device && device.txtRecord && ['Chromecast Audio', 'Google Cast Group', 'JBL Link View', 'Lenovo Smart Display', 'Google Nest Hub', 'Lenovo Smart Clock', 'Google Home', 'Google Home Mini', 'Google Nest Hub Max', 'Google Nest Mini'].indexOf(device.txtRecord.md) !== -1){
...
ControlChromecastSpeakerPlatform.prototype.addAccessory = function (device) {
    ...
    this.api.registerPlatformAccessories('homebridge-chromecast-speaker', 'ChromecastSpeaker', [accessory]);
};

ControlChromecastSpeakerPlatform.prototype.removeAccessory = function (accessory) {
  ...
  this.api.unregisterPlatformAccessories('homebridge-chromecast-speaker', 'ChromecastSpeaker', [accessory]);
};

ControlChromecastSpeakerPlatform.prototype.configureAccessory = function (accessory) {
  this.accessories[accessory.UUID] = accessory;
};

ControlChromecastSpeakerPlatform.prototype.configurationRequestHandler = function (context, request, callback) {  // eslint-disable-line
  let respDict = {};
  ...
  switch (context.onScreen) {
    ...
    case 'DoModify':
      ...
      characteristics = [Characteristic.On, Characteristic.Mute, Characteristic.Volume];
...
ChromecastAccessory.prototype.addEventHandlers = function () {
  ...
  this.addEventHandler(Service.Speaker, Characteristic.Mute);
...
module.exports = function (homebridge) {
  ...
  homebridge.registerPlatform('homebridge-chromecast-speaker', 'ChromecastSpeaker', ControlChromecastSpeakerPlatform, true);
};
